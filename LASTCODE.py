...
# Cálculo de la frecuencia de muestreo y verificación del criterio de Nyquist
fs = info['fs']  # Frecuencia de muestreo obtenida del archivo de datos
frecuencia_maxima = np.max(freqs_psd)  # Máxima frecuencia presente en la señal

# Verificación del criterio de Nyquist
criterio_nyquist = fs >= 2 * frecuencia_maxima

print(f"Frecuencia de muestreo: {fs} Hz")
print(f"Frecuencia máxima en la señal: {frecuencia_maxima:.4f} Hz")
print("Cumple con el criterio de Nyquist" if criterio_nyquist else "No cumple con el criterio de Nyquist")
